...
class Item extends Select
{
    ...
    public function getValueOptions()
    {
        if (empty($this->valueOptions)) {
            ...
            $select = Pi::model('item', $this->options['module'])->select()->columns($columns)->order($order)->limit($limit);
            $rowset = Pi::model('item', $this->options['module'])->selectWith($select);
